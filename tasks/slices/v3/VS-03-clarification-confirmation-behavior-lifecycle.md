...
| `docs/design/adr/ADR-0006-turn-phase-status-v3.md` | Accepted | 固化 phase/status subset |
| `docs/design/adr/ADR-0007-next-action-available-action-v3.md` | Accepted | 固化 next action / available action subset |
| `docs/design/adr/ADR-0008-behavior-state-v3.md` | Accepted | 固化 BehaviorState lifecycle subset |
| `docs/design/adr/ADR-0009-confirmation-binding-v3.md` | Accepted | 固化 confirmation binding 和 re-gate policy |
| `docs/design/contracts/VS-03-behavior-lifecycle-contract-pack.md` | Draft contract pack | 关闭 VS-03 phase / action / behavior / confirmation / proof 文档 blocker |
...
| TurnPhase / TurnStatus subset 明确 | closed | `docs/design/contracts/VS-03-behavior-lifecycle-contract-pack.md` §2 |
| NextAction / AvailableAction subset 明确 | closed | `docs/design/contracts/VS-03-behavior-lifecycle-contract-pack.md` §3 |
| BehaviorState 最小 schema 与 lifecycle 明确 | closed | `docs/design/contracts/VS-03-behavior-lifecycle-contract-pack.md` §4 |
| ConfirmationBinding policy 明确 | closed | `docs/design/contracts/VS-03-behavior-lifecycle-contract-pack.md` §5 |
| TurnResult truthfulness 和 behavior proof 明确 | closed | `docs/design/contracts/VS-03-behavior-lifecycle-contract-pack.md` §6-7 |
...
| docs/design | yes | 本 slice 消费 ADR-0006 至 ADR-0009 和 VS-03 contract pack |
...
| T5 | 补 VS-03 contract pack | done | `docs/design/contracts/VS-03-behavior-lifecycle-contract-pack.md` |
...
- [ ] `rg -n "ADR-0006.*Pro""posed|ADR-0007.*Pro""posed|ADR-0008.*Pro""posed|ADR-0009.*Pro""posed|BehaviorState.*Pro""posed|ConfirmationBinding.*Pro""posed|VS-03.*plan""ned" docs/design tasks/slices/v3`
...
- 2026-05-07 — 新增 `docs/design/contracts/VS-03-behavior-lifecycle-contract-pack.md`，关闭 VS-03 文档 blocker，并将 ADR-0006 至 ADR-0009 标记为 Accepted。仍不授权代码实现。
