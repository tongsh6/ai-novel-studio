...
| `docs/design-v3/adr/ADR-0013-decision-trace-v3.md` | Accepted | 固化 DecisionTrace / ToolTrace 最小语义 |
| `docs/design-v3/adr/ADR-0014-trace-redaction-v3.md` | Accepted | 固化 author-visible trace redaction |
| `docs/design-v3/adr/ADR-0017-replay-report-v3.md` | Accepted | 固化 ReplayCase / ReplayReport 和 no-provider rule |
| `docs/design-v3/contracts/VS-06-replay-surface-contract-pack.md` | Draft contract pack | 关闭 VS-06 replay / summary / proof 文档 blocker |
...
| TraceSummaryView VS-06 subset 明确 | closed | `docs/design-v3/contracts/VS-06-replay-surface-contract-pack.md` §2 |
| ReplayCase 最小 schema 明确 | closed | `docs/design-v3/contracts/VS-06-replay-surface-contract-pack.md` §3 |
| ReplayReport 最小 schema 明确 | closed | `docs/design-v3/contracts/VS-06-replay-surface-contract-pack.md` §4 |
| required replay questions 明确 | closed | `docs/design-v3/contracts/VS-06-replay-surface-contract-pack.md` §5 |
| replay proof 明确 | closed | `docs/design-v3/contracts/VS-06-replay-surface-contract-pack.md` §6 |
...
| docs/design-v3 | yes | 本 slice 消费 ADR-0013、ADR-0014、ADR-0017 和 VS-06 contract pack |
...
| T4 | 补 VS-06 contract pack | done | `docs/design-v3/contracts/VS-06-replay-surface-contract-pack.md` |
...
- [ ] `rg -n "ADR-0017.*Pro""posed|ReplayReport.*Pro""posed|ReplayCase.*Pro""posed|VS-06.*plan""ned" docs/design-v3 tasks/slices/v3`
...
- 2026-05-07 — 新增 `docs/design-v3/contracts/VS-06-replay-surface-contract-pack.md`，关闭 VS-06 文档 blocker，并将 ADR-0017 标记为 Accepted。仍不授权代码实现。
