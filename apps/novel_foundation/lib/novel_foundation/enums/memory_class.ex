# AUTO-GENERATED FROM docs/design/schemas/foundation/enums/memory_class.json — DO NOT EDIT.
# Run `mix codegen.enums` to regenerate; CI runs `mix codegen.enums --check`.
defmodule NovelFoundation.Enums.MemoryClass do
  @moduledoc """
  MemoryClass — generated from `docs/design/schemas/foundation/enums/memory_class.json`.
