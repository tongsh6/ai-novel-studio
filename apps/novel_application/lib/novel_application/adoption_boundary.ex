defmodule NovelApplication.AdoptionBoundary do
  ...
  def evaluate(%CandidateSet{} = candidate_set, chosen_candidate, _tool_result \\ nil) do
    ...
    cond do
      is_nil(candidate) ->
        %AdoptionDecision{
          adoption_decision_id: decision_id, turn_id: candidate_set.turn_id,
          source_action_ref: "choose_candidate", candidate_ref: candidate_id || "unknown",
      ...
      candidate_set.stability != :tentative ->
        %AdoptionDecision{
          adoption_decision_id: decision_id, turn_id: candidate_set.turn_id,
          source_action_ref: "choose_candidate", candidate_ref: candidate_id,
      ...
      candidate.risk_hint == :high ->
        %AdoptionDecision{
          adoption_decision_id: decision_id, turn_id: candidate_set.turn_id,
          source_action_ref: "choose_candidate", candidate_ref: candidate_id,
          decision_type: :require_confirmation, target_ref: candidate.adoption_target_ref,
      ...
      true ->
        %AdoptionDecision{
          adoption_decision_id: decision_id, turn_id: candidate_set.turn_id,
          source_action_ref: "choose_candidate", candidate_ref: candidate_id,
          decision_type: :adopt_tentative, target_ref: candidate.adoption_target_ref,
          adopted_state_ref: "adopted:#{candidate_id}", state_trace_ref: "state_trace:#{decision_id}",
  ...
  defp build_projection_hint(turn_id, _decision_id) do
    %{
      ...
      turn_id: turn_id, projection_ref: "character_list",
      reason: :adopted_state_changed, priority: :normal, stale_strategy: :refresh}
  end
end
