export function Topbar({ manifest, currentScope, currentProject, projects, onBackToCompany, onSelectProject }) {
  return (
    <header className="topbar">
      ...
      <div className="topbar-actions">
        {currentScope === "project" && (
          <>
            <select className="project-switch-select" value={currentProject?.slug || ""} onChange={(event) => onSelectProject?.(event.target.value)}>
