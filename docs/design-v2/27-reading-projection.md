...
> 状态：草案
>
> 角色：`docs/design-v2/20-novel-domain-overview.md` 中阅读层的展开文档，并依赖 `docs/design-v2/11-ux-contract.md`、`docs/design-v2/21-novel-object-model.md`、`docs/design-v2/22-continuity-model.md`、`docs/design-v2/25-maintenance-hooks.md`、`docs/design-v2/26-context-assembly-policy.md`。
>
