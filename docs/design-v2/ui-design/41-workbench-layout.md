...
> 状态：草案
>
> 角色：定义 v2 UI 主工作台（Workbench）的整体布局与区域职责。
...
- `../11-ux-contract.md`：UI 只能投影运行语义。
- `../28-authoring-lifecycle.md`：创作生命周期的阶段感知。
- `../adr/0001-turn-result-v2-schema.md`：顶层数据读取路径。
...
- **渐进披露**：遵循 ADR-0015 原则，展开后也不应直接铺满所有字段。
