...
- `../21-novel-object-model.md`：核心小说对象模型。
- `../22-continuity-model.md`：连贯性模型（Foreshadowing 等）。
- `../34-novel-element-field-priority.md`：元素字段呈现优先级。
- `../adr/0014-experience-ui-context-boundary.md`：experience evidence / artifact / rule 的 UI 边界。
- `../adr/0015-structure-panel-field-priority.md`：结构面板渐进披露的 L1-L4 分层设计。
