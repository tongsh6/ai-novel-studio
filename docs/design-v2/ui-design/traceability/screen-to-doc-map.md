...
>
> 角色：在 `novel-studio-v2.pen` 创建 screen 后，记录每个 screen 与 UI 文档、ADR 来源的对应关系。

---

| Screen frame name (ID) | UI 文档章节 | 关键 contract 来源 | 状态 |
| --- | --- | --- | --- |
| `41§3-main-workbench` (ZOwOi) | `ui-design/41-workbench-layout.md` §3 | ADR-0001 / ADR-0002 / ADR-0006 | ✅ 已修订：结构入口默认折叠；已导出 PNG |
