...
- [ ] 已阅读对应的 UI 设计文档章节（`40`-`47`）
  - 设计文档目录：`docs/design-v2/ui-design/`
...
- [ ] 已查看对应的 Pencil 原型 screen frame
  - 原型文件：`docs/design-v2/ui-design/novel-studio-v2.pen`
  - 导出预览：`docs/design-v2/ui-design/exports/png/`
...
- [ ] 已准备好组件头部的设计追溯注释：
  ```
  // Design: docs/design-v2/ui-design/<文档>.md §<章节>
  // Prototype: novel-studio-v2.pen → <screen-frame-name> (<NODE_ID>)
  ```
