...
> 状态：草案
>
> 角色：`docs/design-v2/01-agent-foundation-contract.md` 的 Provider Abstraction 子系统展开文档，并依赖 `docs/design-v2/04-capability-and-intent-registry.md` 与 `docs/design-v2/06-planning-and-long-run.md`。
>
