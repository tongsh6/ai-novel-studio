...
> 状态：草案
>
> 角色：`docs/design-v2/21-novel-object-model.md` 的风格与作者意志子模型展开文档，并依赖 `docs/design-v2/05-memory-retention-and-retrieval.md`、`docs/design-v2/06-planning-and-long-run.md`、`docs/design-v2/11-ux-contract.md`。
>
