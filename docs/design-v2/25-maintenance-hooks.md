...
> 状态：草案
>
> 角色：`docs/design-v2/24-novel-intent-catalog.md` 中维护族的运行展开文档，并依赖 `docs/design-v2/06-planning-and-long-run.md`、`docs/design-v2/11-ux-contract.md`、`docs/design-v2/22-continuity-model.md`。
>
