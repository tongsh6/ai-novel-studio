...
| 小说质量门禁 | AI 产出的创作材料能被检查、警告、确认、采纳或阻断 | `docs/design-v2/31-novel-quality-gates.md`、`docs/design-v2/32-human-approval-policy.md`、v3 contract packs |
...
rg -n "VS-00"" 至 VS-06|VS-01"" 至 VS-06|VS-00 / VS-00A / VS-00B / VS-01"" 至 VS-06" docs/design-v3 tasks/slices/v3
```
...
| Invariant | 指向 `docs/design-v3/00c-state-and-contract-atlas.md` 的全局不变量 |
...
来源：`docs/design-v2/31-novel-quality-gates.md`。
...
- `docs/design-v2/32-human-approval-policy.md`
- `docs/design-v2/10-security-and-budget.md`
- `docs/design-v3/adr/ADR-0010-state-adoption-boundary-v3.md`
...
- `docs/design-v3/adr/ADR-0013-decision-trace-v3.md`
- `docs/design-v3/adr/ADR-0017-replay-report-v3.md`
