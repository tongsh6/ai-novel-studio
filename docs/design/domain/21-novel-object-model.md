...
>
> 角色：`docs/design/domain/20-novel-domain-overview.md` 的对象模型展开文档，并依赖 `docs/design/foundation/00e-architecture.md`、`docs/design/06-memory-context-and-trace.md`、`docs/design/05-turn-behavior-and-state-model.md`。
>
