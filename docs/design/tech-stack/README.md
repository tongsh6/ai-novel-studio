...
```text
docs/design/             docs/design/tech-stack/
├── 是什么 / 为什么          ├── 用什么 / 怎么落地
├── ADR 锁定语义             ├── 工程决策可演进
├── 不绑技术栈               ├── 围绕技术栈展开
...
本目录所有文档**只引用、不修改**当前 `docs/design/` 下已冻结的 contract：

| 主目录文档 | 在本目录被引用的位置 |
|---|---|
| [`../00d-runtime-architecture.md`](../00d-runtime-architecture.md) | `03-backend.md`、`05-desktop.md`、`11-deployment.md` |
| [`../07-workbench-ui-contract.md`](../07-workbench-ui-contract.md) | `04-frontend.md`、`09-schema-codegen.md` |
| [`../contracts/VS-05-ui-roundtrip-contract-pack.md`](../contracts/VS-05-ui-roundtrip-contract-pack.md) | `04-frontend.md`、`09-schema-codegen.md` |
| [`../adr/ADR-0015-turn-result-view-model-v3.md`](../adr/ADR-0015-turn-result-view-model-v3.md) | `09-schema-codegen.md` |
| [`../adr/ADR-0016-projection-hint-ui-v3.md`](../adr/ADR-0016-projection-hint-ui-v3.md) | `08-multi-agent.md`、`10-observability.md` |
| [`../03-capability-toolbox-contract.md`](../03-capability-toolbox-contract.md) | `08-multi-agent.md` 全文核心 |
