...
- `docs/design/02-dialogue-frame-and-micro-plan.md`
- `docs/design/03-capability-toolbox-contract.md`
- `docs/design/04-execution-orchestrator.md`
- `docs/design/05-turn-behavior-and-state-model.md`
...
- `docs/design/00d-runtime-architecture.md`
