...
| 契约 / 代码 | 用途 |
|---|---|
| `docs/design-v3/adr/ADR-0016-projection-hint-ui-v3.md` | ProjectionHint 只刷新、不写入的权威决策 |
| `docs/design-v3/contracts/VS-04-adoption-boundary-contract-pack.md` | AdoptionDecision、ProjectionHint、adoption boundary |
| `docs/design-v3/07-workbench-ui-contract.md` | Workbench / ReadingMode 消费 TurnResult 与 projection hints 的 UI 规则 |
...
| 当前状态 | 前端局部实现 |
| 当前缺口 | 按钮使用 inline style；是否符合 v2 UI 设计和文案集中管理需另行验收 |
| 优先级 | P2 |
...
| AU08-GAP-09 — 阅读入口设计合规待核查 | `[阅读模式]` inline style 按钮 | 对齐 v2 UI/文案规范 | P2 |
