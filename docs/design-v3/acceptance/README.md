...
| freshness/conflict/cross-work 与高风险确认 | AU-05 AU05-GAP-06~07 | 高风险 confirmation checkpoint 与 stale restored candidate rejection checkpoint 已闭环；conflict/cross-work 继续补实现/补测试/补集成 | P0 |
