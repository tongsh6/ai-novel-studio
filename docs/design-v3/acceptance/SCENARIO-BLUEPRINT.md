...
| AU-02 候选方向状态已重算 | backend fallback/real_llm 证据已进入验收文档；候选卡点选、采纳桥接、高风险候选 confirmation checkpoint 和 stale restored candidate rejection checkpoint 已闭环 | 下一步继续 AU05-GAP-06：conflict/cross-work |
