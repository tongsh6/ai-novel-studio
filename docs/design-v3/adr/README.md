...
| ADR-0018 | `ADR-0018-business-log-schema-v3.md` | Accepted | 业务日志 Schema v3 | `06`, `engineering/v3-quality-gates.md`, 既有 `llm_log.ex` / `trace_repository.ex` | VS-10 Observability Spine |
